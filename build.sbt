...
lazy val webapp = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    ...
    libraryDependencies                   ++= Seq(
      ...
      "com.github.rescala-lang.rescala"       %%% "rescala"                               % "42a7e0279afffa7f2885f9ea2a37216076325d7f",
      "com.github.rescala-lang.rescala"       %%% "kofre"                                 % "42a7e0279afffa7f2885f9ea2a37216076325d7f",
