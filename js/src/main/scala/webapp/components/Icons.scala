...
object Icons {
  ...
  def checkmarkCircle(_cls: String = "", _color: String = "#212121") = {
    import svg.*
    svg(
      xmlns := "http://www.w3.org/2000/svg",
      viewBox := "0 0 48 48",
      cls := _cls,
      g(
        idAttr := "🔍-Product-Icons",
        stroke := "none",
        VModifier.attr("stroke-width") := "1",
        fill := "none",
        VModifier.attr("fill-rule") := "evenodd",
        g(
          fill := _color,
          VModifier.attr("fill-rule") := "nonzero",
          path(
  ...
  def warningTriangle(_cls: String = "", _color: String = "#212121") = {
    import svg.*
    svg(
      xmlns := "http://www.w3.org/2000/svg",
      viewBox := "0 0 24 24",
  ...
  def warningPolygon(_cls: String = "") = {
    import svg.*
    svg(
      xmlns := "http://www.w3.org/2000/svg",
      cls := _cls,
  ...
  def infoStar(_cls: String = "", _color: String = "#292D32") = {
    import svg.*
    svg(
      xmlns := "http://www.w3.org/2000/svg",
      cls := _cls,
